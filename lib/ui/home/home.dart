          ...
          return InkWell(
            onTap: () {
              Navigator.pushNamed(context, Routes.detail,
                  arguments: _postStore.agentList!.data[index]);
            },
            child: Stack(
              children: [
                Transform(
                ...
                _postStore.agentList!.data[index].fullPortrait != null
                    ? Align(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:
                              _postStore.agentList!.data[index].bustPortrait!,
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _postStore.agentList!.data[index].role != null
                            ? _postStore
                                .agentList!.data[index].role!.displayName
                            : "",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: AppColors.mainTextColor,
