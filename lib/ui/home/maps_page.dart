          ...
          children: <Widget>[
           ...
           //   tabs: tabs,
            ...
            Observer(builder: (context) {
              if (_postStore.mapList != null) {
                return _postStore.mapList!.data.isNotEmpty
                    ? IndexedStack(
                        index: selectedIndex,
                        children: [
                          _gridCards(),
  ...
  Widget _gridCards() {
    return Observer(builder: (context) {
      return GridView.builder(
        ...
        itemCount: _postStore.mapList!.data.length,
          ...
          return InkWell(
            onTap: () {
              Navigator.pushNamed(context, Routes.detail,
                  arguments: _postStore.mapList!.data[index]);
            },
            child: Stack(
              children: [
                Transform(
                ...
                _postStore.mapList!.data[index].displayIcon != null
                    ? Align(
                        alignment: Alignment.bottomCenter,
                        child: CachedNetworkImage(
                          imageUrl: _postStore.mapList!.data[index].displayIcon,
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        _postStore.mapList!.data[index].displayName,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: AppColors.mainTextColor,
                          fontWeight: FontWeight.w600,
                      ...
                      /*             Text(
                        _postStore.mapList!.data[index].role != null
                            ? _postStore
                                .mapList!.data[index].role!.displayName
                            : "",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: AppColors.mainTextColor,
